...
(1, 'Bobbie', 1, 1, 'Koorts, eet slecht, blaft veel te veel', 'M'),
(2, 'Minoes', 2, 2, 'Drinkt niet, haaruitval, mager', 'V'),
(3, 'Kees', 1, 2, 'Eet te veel, vetzucht, jankt en kotst', 'V'),
(9, 'Blikkie', 1, 1, 'Blaft veel over kranten', 'M');
